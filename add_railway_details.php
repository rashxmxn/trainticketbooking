...
<html>
	...
	<body>
		...
		<form action="add_railway_details_form_handler.php" method="post">
			<h2>ENTER THE RAILWAY SCHEDULE DETAILS</h2>
			<?php
				if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<strong style='color: green'>The Railway Schedule has been successfully added.</strong>
						<br>
						<br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color: red'>*Invalid Railway Schedule Details, please enter again.</strong>
						<br>
						<br>";
				}
			?>
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Railway Number</td>
				</tr>
				<tr>
					<td class="fix_table"><input type="text" name="railway_no" required></td>
				</tr>
			</table>
			<br>
			<hr>
			...
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Train ID</td>
				</tr>
				<tr>
					<td class="fix_table">
