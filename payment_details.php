...
<html>
	<head>
		...
		<script src="https://kit.fontawesome.com/28d47d054e.js" crossorigin="anonymous"></script>
	</head>
	<body>
		...
		<form action="payment_details_form_handler.php" method="post">
			...
			<?php
				...
				echo "<tr>";
				echo "<td class=\"fix_table\">Ticket price:</td>";
				echo "<td class=\"fix_table\">&#x20b8; ".$total_ticket_price."</td>";
				echo "</tr>";

				echo "<tr>";
				echo "<td class=\"fix_table\">Meal:</td>";
			...
			<br>
			<input type="submit" value="Pay Now" name="Pay_Now" style="margin-left: 70px">
		</form>
	</div>
		<!-- 
•	Booking_Status
