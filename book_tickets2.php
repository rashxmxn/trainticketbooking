...
<html>
	...
	<body>
		...
		<?php
			...
			$railway_no=$_POST['select_railway'];
			$_SESSION['railway_no']=$railway_no;
			//$pass_name=array();
			...
			while($count<=$no_of_pass)
			{
					...
					echo "<td class=\"fix_table_short\">Frequent Passenger ID (if applicable)</td>";
					echo "</tr>";
					echo "<tr>";
				...
				echo "<input type=\"submit\" value=\"Submit Travel/Ticket Details\" name=\"Submit\" style=\"margin-left: 300px\">";
				echo "</form>";
		?>
	</div>
